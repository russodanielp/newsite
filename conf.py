...
BLOG_AUTHOR = "Daniel P. Russo"  # (translatable)
BLOG_TITLE = "Drug Discovery in Python"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.danielprusso.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "russodanielp@gmail.com"
BLOG_DESCRIPTION = "Blogging and programming the research interests of Daniel P. Russo."  # (translatable)
...
POSTS =(
    ("posts/*.ipynb", "blog", "page.tmpl"),
    ("posts/*.md", "blog", "page.tmpl"),
    ("posts/*.rst", "blog", "page.tmpl"),
    ("posts/*.html", "blog", "page.tmpl")
)
